...
class DirectoryCsrFragment : BaseFragment<DirectoryCsrFragmentBinding>(
    layoutId = R.layout.directory_csr_fragment
) {

    companion object {
        const val REQUEST_KEY = "DirectoryCsrFragmentPickFile"
    }
...
//                        findNavController().navigate(action)
    ...
    private fun getAllFile() {
        ...
        lifecycleScope.launch {
            viewModel.getExternalStorageDirectory(requireCompatActivity()).let {
                it?.let { it1 ->
