...
import th.or.etda.teda.mobile.data.csr.CsrDao
...
import th.or.etda.teda.mobile.ui.csr.CsrViewModel
import th.or.etda.teda.mobile.ui.csr.InetWebViewModel
import th.or.etda.teda.mobile.ui.csr.directory.DirectoryCsrViewModel
import th.or.etda.teda.mobile.ui.csr.list.CsrListViewModel
...
val viewModelModule = module {
    ...
    fun provideCsrViewModel(dao: CsrDao): CsrViewModel {
        return CsrViewModel(CsrRepository(dao))
    }
    fun provideCsrListViewModel(dao: CsrDao): CsrListViewModel {
        return CsrListViewModel(CsrRepository(dao))
    }
    ...
    factory { provideCsrViewModel(get()) }
    factory { provideCsrListViewModel(get()) }
    factory { DirectoryCsrViewModel() }
    factory { InetWebViewModel() }
}
